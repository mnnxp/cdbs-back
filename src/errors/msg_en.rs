...
pub(crate) fn value_in_err_msg_en(err_msg: ErrorMessage) -> String {
    match err_msg {
        ...
        ErrorMessage::NoActiveFileRevisionFound =>
            String::from("No active file revision found"),
        ...
        ErrorMessage::NotFoundAccessForRole =>
            String::from("Not found access for target role"),
        ErrorMessage::NotFoundFilename =>
            String::from("Not found filename"),
        ErrorMessage::NotFoundFilesetData =>
            String::from("Not found fileset data"),
        ErrorMessage::NotFoundKeywords =>
            String::from("Not found keywords"),
        ErrorMessage::NotFoundModificationData =>
            String::from("Not found modification data"),
        ...
        ErrorMessage::NotFoundParamsForDeleting =>
            String::from("Not found params for deleting"),
        ErrorMessage::NotFoundRepresentative =>
            String::from("Not found representative"),
        ErrorMessage::NotFoundRolesForCompany =>
            String::from("Not found roles for company"),
        ...
        ErrorMessage::RoleNotFound =>
            String::from("Role not found"),
        ErrorMessage::SelectedFileIsNotImage =>
            String::from("Selected file is not image"),
        ErrorMessage::SpecNotFound =>
            String::from("Spec not found"),
        ErrorMessage::CompanyIsNotSupplier =>
            String::from("The company is not supplier"),
        ErrorMessage::ComponentIsNotStandard =>
            String::from("The component is not standard"),
        ErrorMessage::DataHasAlready =>
            String::from("The data has already"),
        ...
        ErrorMessage::UserNotFoundInCompany =>
            String::from("The user not found in the company"),
        ...
        ErrorMessage::TokenIsInvalid =>
            String::from("Your token is invalid"),
