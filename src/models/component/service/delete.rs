...
use crate::schema::{
    component_ref::dsl as component_ref, file_to_component::dsl as file_to_component,
};
use diesel::prelude::*;
use uuid::Uuid;
...
fn delete_component_files(component_uuid: &Uuid, conn: &mut PgConnection) -> ServiceResult<bool> {
