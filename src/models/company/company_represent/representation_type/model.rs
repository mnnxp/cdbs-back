...
/// Локализованное наименование типа представительства компании
...
pub(crate) struct RepresentationTypeTranslateList {
    /// Идентификатор типа представительства
    pub(crate) representation_type_id: i32,
    /// Идентификатор языка наименования
    pub(crate) lang_id: i32,
    /// Наименование типа представительства
