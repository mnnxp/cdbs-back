...
ALTER TABLE license_permission_ref ADD CONSTRAINT license_permission_ref_fk0 FOREIGN KEY (id_lang) REFERENCES language_ref(id);

ALTER TABLE license_limitation_ref ADD CONSTRAINT license_limitation_ref_fk0 FOREIGN KEY (id_lang) REFERENCES language_ref(id);

ALTER TABLE license_condition_ref ADD CONSTRAINT license_condition_ref_fk0 FOREIGN KEY (id_lang) REFERENCES language_ref(id);
