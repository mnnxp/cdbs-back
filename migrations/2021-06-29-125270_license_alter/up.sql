...
ALTER TABLE license_permission_translate_list ADD CONSTRAINT license_permission_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
...
ALTER TABLE license_limitation_translate_list ADD CONSTRAINT license_limitation_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
...
ALTER TABLE license_condition_translate_list ADD CONSTRAINT license_condition_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
