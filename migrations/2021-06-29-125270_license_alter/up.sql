...
ALTER TABLE license_permission_translate_list ADD CONSTRAINT license_permission_translate_list_fk0 FOREIGN KEY (id_license_permission) REFERENCES license_permission_ref(id) ON DELETE CASCADE;
...
ALTER TABLE license_limitation_translate_list ADD CONSTRAINT license_limitation_translate_list_fk0 FOREIGN KEY (id_license_limitation) REFERENCES license_limitation_ref(id) ON DELETE CASCADE;
...
ALTER TABLE license_condition_translate_list ADD CONSTRAINT license_condition_translate_list_fk0 FOREIGN KEY (id_license_condition) REFERENCES license_condition_ref(id) ON DELETE CASCADE;
