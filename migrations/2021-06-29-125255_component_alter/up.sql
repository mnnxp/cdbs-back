-- Your SQL goes here
ALTER TABLE component_ref ADD CONSTRAINT component_ref_fk0 FOREIGN KEY (parent_component_uuid) REFERENCES component_ref(uuid);
...
ALTER TABLE component_ref ADD CONSTRAINT component_ref_fk2 FOREIGN KEY (type_access_id) REFERENCES type_access_ref(id);
ALTER TABLE component_ref ADD CONSTRAINT component_ref_fk3 FOREIGN KEY (component_type_id) REFERENCES component_type_ref(id);
ALTER TABLE component_ref ADD CONSTRAINT component_ref_fk4 FOREIGN KEY (actual_status_id) REFERENCES actual_status_ref(id);

ALTER TABLE component_history_list ADD CONSTRAINT component_history_list_fk0 FOREIGN KEY (component_uuid) REFERENCES component_ref(uuid);
ALTER TABLE component_history_list ADD CONSTRAINT standard_history_list_fk1 FOREIGN KEY (type_of_change_id) REFERENCES type_of_change_ref(id);
...
ALTER TABLE component_type_translate_list ADD CONSTRAINT component_type_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id);
...
ALTER TABLE discussion_component_ref ADD CONSTRAINT discussion_component_ref_fk0 FOREIGN KEY (parent_discussion_id) REFERENCES discussion_component_ref(id);
ALTER TABLE discussion_component_ref ADD CONSTRAINT discussion_component_ref_fk1 FOREIGN KEY (component_uuid) REFERENCES component_ref(uuid);
ALTER TABLE discussion_component_ref ADD CONSTRAINT discussion_component_ref_fk2 FOREIGN KEY (author_uuid) REFERENCES user_ref(uuid);

ALTER TABLE component_modification_list ADD CONSTRAINT component_modification_list_fk0 FOREIGN KEY (component_uuid) REFERENCES component_ref(uuid);
ALTER TABLE component_modification_list ADD CONSTRAINT component_modification_list_fk1 FOREIGN KEY (parent_modification_uuid) REFERENCES component_modification_list(uuid);
ALTER TABLE component_modification_list ADD CONSTRAINT component_modification_list_fk2 FOREIGN KEY (actual_status_id) REFERENCES actual_status_ref(id);
...
ALTER TABLE set_files_for_program ADD CONSTRAINT set_files_for_program_fk0 FOREIGN KEY (modification_uuid) REFERENCES component_modification_list(uuid);
ALTER TABLE set_files_for_program ADD CONSTRAINT set_files_for_program_fk1 FOREIGN KEY (program_id) REFERENCES program_ref(id);

ALTER TABLE file_to_set_modification ADD CONSTRAINT file_to_set_modification_fk0 FOREIGN KEY (set_id) REFERENCES set_files_for_program(id) ON DELETE CASCADE;
ALTER TABLE file_to_set_modification ADD CONSTRAINT file_to_set_modification_fk1 FOREIGN KEY (file_uuid) REFERENCES file_ref(uuid) ON DELETE CASCADE;
