...
ALTER TABLE set_files_for_program ADD CONSTRAINT set_files_for_program_fk0 FOREIGN KEY (modification_uuid) REFERENCES component_modification_list(uuid) ON DELETE CASCADE;
ALTER TABLE set_files_for_program ADD CONSTRAINT set_files_for_program_fk1 FOREIGN KEY (program_id) REFERENCES program_ref(id) ON DELETE CASCADE;
