...
ALTER TABLE license_to_component ADD CONSTRAINT license_to_component_fk0 FOREIGN KEY (uuid_component) REFERENCES component_ref(uuid);
ALTER TABLE license_to_component ADD CONSTRAINT license_to_component_fk1 FOREIGN KEY (id_license) REFERENCES license_ref(id);

ALTER TABLE standard_to_component ADD CONSTRAINT standard_to_component_fk0 FOREIGN KEY (uuid_component) REFERENCES component_ref(uuid);
ALTER TABLE standard_to_component ADD CONSTRAINT standard_to_component_fk1 FOREIGN KEY (uuid_standard) REFERENCES standard_ref(uuid);
