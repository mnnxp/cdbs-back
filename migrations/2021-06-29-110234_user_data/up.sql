...
INSERT INTO user_ref (uuid, email, psw_hash, psw_salt,
  ...
  position, time_zone, uuid_image_file, id_region, id_program, id_type_access,
  ...
  ('68b8281a-d19c-4d4b-88eb-6fd4a2afde1b', 'test@test.com', E'\\x085f06287c840b5c23578912d5e0cc2e4baf53865e9170a05ed084c1292ab7f4', 'pKFpenRqOFyutR#OAkxb%!bi%mV5q(GPKgHmwQ*bWrcuJHC3k8raBNzUnw7r%^oFKzBf%McZlVBI#O@U1@JApg@rVHEuzlybCWx&BXjrI(41x)8kR9rjURVG9lqr0EIM', 'Vans', 'Bpero', 'Nado', 'albane', 'none', 'none', 'noneadress', 'engineer', 'Europe/Moscow', 'bc1c2151-86d0-4656-9c9d-d016dd584297', 4, 1, 1, 'f', 't', 'f', now(), now()),
  ...
  ('c3f5f69c-bb54-45d9-bfa7-1d28cc1afa5a', 'bname@somain.com', E'\\xfdeba1b9304208da90c90ddb6fe0ee49787b085636b26f156d6240869bdb3665', 'ThmlF#HCNEX6%##AFGH(%0Tdo0w$5kh(WA9%@KwHe3mrVlhMIj~NxeiiJyh~Ty1t(J3F#lGDWFFJRZnV1&WFMA%Rl5~8qvfW)5WjL&qm%jSuFx1Uslth^a$64YkJjN)q', 'Xans', 'Gpero', 'Bado', 'testusertext', 'none', 'none', 'noneadress', 'noneposition', 'Europe/Moscow', 'bc1c2151-86d0-4656-9c9d-d016dd584297', 4, 1, 1, 'f', 't', 'f', now(), now());
