...
INSERT INTO company_ref (uuid, orgname, shortname, inn, phone,
  ...
  uuid_image_file, id_region, id_company_type, id_type_access, is_supplier, is_email_verified,
...
INSERT INTO company_type_translate_list (id_company_type, id_lang, name, shortname) VALUES
...
INSERT INTO representation_type_translate_list (id_representation_type, id_lang, representation_type) VALUES
  (1, 1, 'Office'),
  (2, 1, 'Branch');
...
INSERT INTO role_member_translate_list (id_role_member, id_lang, name) VALUES
  (1, 1, 'Trainee'),
  (2, 1, 'Designer'),
  (3, 1, 'Engineer'),
  (4, 1, 'Constructor'),
