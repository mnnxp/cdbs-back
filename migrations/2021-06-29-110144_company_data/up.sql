...
INSERT INTO type_company_ref (id_lang, name, shortname) VALUES
  (1, 'Individual entrepreneur', 'IP'),
  (1, 'Joint Stock Companies', 'AO'),
  (1, 'Public Joint Stock Companies', 'PJSC'),
  (1, 'Non-public joint stock companies', 'NAO'),
  (1, 'Limited Liability Company', 'LLC'),
  (1, 'Business partnerships', 'H.part-va'),
  (1, 'Production cooperatives (artels)', 'Artel'),
  (1, 'Agricultural production cooperatives', 'Agricultural'),
  (1, 'Cooperative farms (cooperative farms)', 'Cooperative farms'),
  (1, 'Other legal entities that are commercial organizations', 'Others'),
  (2, 'Индивидуальный предприниматель', 'ИП'),
  (2, 'Акционерные общества', 'АО'),
  (2, 'Публичные акционерные общества', 'ПАО'),
  (2, 'Непубличные акционерные общества', 'НАО'),
  (2, 'Общества с ограниченной ответственностью', 'ООО'),
  (2, 'Хозяйственные партнерства', 'Х.парт-ва'),
  (2, 'Производственные кооперативы (артели)', 'Артель'),
  (2, 'Сельскохозяйственные производственные кооперативы', 'Сельхоз'),
  (2, 'Кооперативные хозяйства (коопхозы)', 'Коопхоз'),
  (2, 'Прочие юридические лица, являющиеся коммерческими организациями', 'Прочие');
...
INSERT INTO representation_type_ref (id_lang, representation_type) VALUES
  (1, 'Office'),
  (1, 'Branch');

INSERT INTO role_member_ref (id_lang, name) VALUES
  (1, 'Trainee'),
  (1, 'Designer'),
  (1, 'Engineer'),
  (1, 'Constructor'),
