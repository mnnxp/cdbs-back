...
ALTER TABLE company_access_to_component ADD CONSTRAINT company_access_to_component_fk0 FOREIGN KEY (uuid_component) REFERENCES component_ref(uuid);
ALTER TABLE company_access_to_component ADD CONSTRAINT company_access_to_component_fk1 FOREIGN KEY (uuid_company) REFERENCES company_ref(uuid);
ALTER TABLE company_access_to_component ADD CONSTRAINT company_access_to_component_fk2 FOREIGN KEY (id_type_access) REFERENCES type_access_ref(id);
