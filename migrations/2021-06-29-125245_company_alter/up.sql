...
ALTER TABLE type_company_translate_list ADD CONSTRAINT type_company_translate_list_fk0 FOREIGN KEY (id_type_company) REFERENCES type_company_ref(id) ON DELETE CASCADE;
