...
ALTER TABLE company_type_translate_list ADD CONSTRAINT company_type_translate_list_fk0 FOREIGN KEY (id_company_type) REFERENCES company_type_ref(id) ON DELETE CASCADE;
ALTER TABLE company_type_translate_list ADD CONSTRAINT company_type_translate_list_fk1 FOREIGN KEY (id_lang) REFERENCES language_ref(id);

ALTER TABLE representation_type_translate_list ADD CONSTRAINT representation_type_translate_list_fk0 FOREIGN KEY (id_representation_type) REFERENCES representation_type_ref(id) ON DELETE CASCADE;
...
ALTER TABLE role_member_translate_list ADD CONSTRAINT role_member_translate_list_fk0 FOREIGN KEY (id_role_member) REFERENCES role_member_ref(id) ON DELETE CASCADE;
