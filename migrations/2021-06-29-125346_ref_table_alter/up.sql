-- Your SQL goes here
ALTER TABLE extension_ref ADD CONSTRAINT extension_ref_fk0 FOREIGN KEY (program_id) REFERENCES program_ref(id) ON DELETE CASCADE;

ALTER TABLE file_ref ADD CONSTRAINT file_ref_fk0 FOREIGN KEY (parent_file_uuid) REFERENCES file_ref(uuid) ON DELETE CASCADE;
ALTER TABLE file_ref ADD CONSTRAINT file_ref_fk1 FOREIGN KEY (user_uuid) REFERENCES user_ref(uuid) ON DELETE CASCADE;
ALTER TABLE file_ref ADD CONSTRAINT file_ref_fk2 FOREIGN KEY (id_ext) REFERENCES extension_ref(id) ON DELETE CASCADE;
...
ALTER TABLE actual_status_translate_list ADD CONSTRAINT actual_status_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
...
ALTER TABLE type_access_translate_list ADD CONSTRAINT type_access_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
...
ALTER TABLE param_translate_list ADD CONSTRAINT param_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
...
ALTER TABLE region_translate_list ADD CONSTRAINT region_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
...
ALTER TABLE spec_translate_list ADD CONSTRAINT spec_translate_list_fk1 FOREIGN KEY (lang_id) REFERENCES language_ref(id) ON DELETE CASCADE;
