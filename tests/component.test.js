...
describe('component', () => {
  ...
  it('/graphql:M List paramComponent - BadRequest no token', async (done) => {
    const { body } = await agent
      .post('/graphql')
      .send({
    ...
    expect(body.errors[0].path[0]).toBe('paramComponent');
    done();
  });

  it('/graphql:Q List paramComponent - OK', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
  ...
  it('/graphql:Q List paramComponent - OK filter idParam', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
      ...
      .expect(HttpStatus.OK);
    debug('/graphql paramComponent =%o', response1.body.data.paramComponent);
    expect(response1.body.data.paramComponent).toBeNonEmptyArray();
    expect(response1.body.data.paramComponent[0].idParam).toBe(paramnameIndex);
    done();
  });

  it('/graphql:Q List paramComponent - OK filter uuidComponent', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
  ...
  it('/graphql:Q List paramComponent - OK filter idParam and uuidComponent', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
  ...
  it('/graphql:M List componentModification - BadRequest no token', async (done) => {
    const { body } = await agent
      .post('/graphql')
      .send({
        query: `query componentModificationQuery {
  ...
  it('/graphql:Q List componentModification - OK with uuidComponentStandard', async (done) => {
    const { body } = await agent
      .post('/graphql')
      .set(
        'Authorization',
      ...
      .send({
        query: `query componentModification {
            componentModification (uuidComponent: "${uuidComponentStandard}") {
                uuid
                uuidComponent
                uuidModificationParent
                modificationName
  ...
  it('/graphql:Q List componentModification - OK with uuidComponentNoStandard', async (done) => {
    const { body } = await agent
      .post('/graphql')
      .set(
        'Authorization',
      ...
      .send({
        query: `query componentModification {
            componentModification (uuidComponent: "${uuidComponentNoStandard}") {
                uuid
                uuidComponent
                uuidModificationParent
                modificationName
    ...
    expect(componentModification).toBeNonEmptyArray();
    expect(componentModification[0].uuidComponent).toBe(uuidComponentNoStandard);
    expect(componentModification.pop().uuidComponent).toBe(uuidComponentNoStandard);
    done();
  });

  it('/graphql:Q List componentModification - BadRequest no token', async (done) => {
    const { body } = await agent
      .post('/graphql')
      .send({
        query: `query componentModification {
  ...
  it('/graphql:M List paramModification - BadRequest no token', async (done) => {
    const { body } = await agent
      .post('/graphql')
      .send({
    ...
    expect(data).toBeNull();
    expect(errors[0].message).toBe("BadRequest: Token not found.");
    expect(body.errors[0].path[0]).toBe('paramModification');
    done();
  });

  it('/graphql:Q List paramModification - OK', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
      ...
      .expect(HttpStatus.OK);
    debug('/graphql all paramModification=%o', response1.body.data.paramModification);
    expect(response1.body.data.paramModification).toBeNonEmptyArray();
    done();
  });

  it('/graphql:Q List paramModification - OK filter idParam', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
  ...
  it('/graphql:Q List ParamModification - OK filter uuidModification', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
  ...
  it('/graphql:Q List ParamModification - OK filter idParam and uuidModification', async (done) => {
    const response1 = await agent
      .post('/graphql')
      .set(
        'Authorization',
